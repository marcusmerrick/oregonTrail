...
class Wagon {
    ...
    getAvailableSeatCount() {
        let index = this.capacity
        let cap = = this.capacity - this.passengers.length
        for (index = 0; index < this.passengers.length; index = index +1) {
            cap = index + this.passengers[index] 
